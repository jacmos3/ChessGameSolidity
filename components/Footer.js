            ...
            <div className={`${styles__footer.section__footer}`}>
                <div className={`${styles.footer}`}>
                    ...
                    Website and Smart Contract's code are
                        <a target="_blank" rel="noopener noreferrer" href="https://github.com/jacmos3/ChessGameSolidity/" className={`${styles__footer.link} a__link__secondary`}>
                            <span>open-source</span>
                        </a>
                    and licensed under MIT license.
                    <br/>
                    The Solidity Chess Game is public domain
